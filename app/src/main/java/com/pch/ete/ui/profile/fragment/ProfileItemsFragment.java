...
public class ProfileItemsFragment extends BaseFragment {
    ...
    private static ProfileItemsFragment instance;

    public static ProfileItemsFragment getInstance() {
        if (instance == null)
            instance = new ProfileItemsFragment();
