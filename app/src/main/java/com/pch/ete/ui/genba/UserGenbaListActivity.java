...
public class UserGenbaListActivity extends BaseActivity implements IApiCallback, IRecyclerClickListener, Handler.Callback, SwipeRefreshLayout.OnRefreshListener {
...
//        getMySR();
    ...
    private void getMySR() {
        if (InternetCheck.isConnectedToInternet(this)) {
            ...
            isLoading = true;
            ApiCall.getInstance().getUserGenaList(preference.getAccessToken(), mSearchTxt, page, this);
        }
    }
    ...
    public void onRecyclerClick(int pos, Object data, Object type) {
        ...
        if (type.toString().equals("click_join")) {
            ...
            mOpponentId = serviceRequestData.getId()+"_"+serviceRequestData.getVendorData().getId();
